...
namespace Nop.Plugin.Payments.Weixin
{
    public class WeixinPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Weixin.PaymentMethodDescription", "您将使用微信支付来完成订单");
            base.Install();
        }
        ...
        {
            get { return _localizationService.GetResource("Plugins.Payments.WeiXin.PaymentMethodDescription"); }
